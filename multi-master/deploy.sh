...
ID_M2=$(/usr/local/bin/terraform output | grep 'k8s-master 2 -' | awk '{print $4;exit}')
ID_M2_DNS=$(/usr/local/bin/terraform output | grep 'k8s-master 2 -' | awk '{print $9;exit}' | cut -b 8-)

ID_M3=$(/usr/local/bin/terraform output | grep 'k8s-master 3 -' | awk '{print $4;exit}')
ID_M3_DNS=$(/usr/local/bin/terraform output | grep 'k8s-master 3 -' | awk '{print $9;exit}' | cut -b 8-)


ID_HAPROXY=$(/usr/local/bin/terraform output | grep 'k8s_proxy -' | awk '{print $3;exit}')
ID_HAPROXY_DNS=$(/usr/local/bin/terraform output | grep 'k8s_proxy -' | awk '{print $8;exit}' | cut -b 8-)


ID_W1=$(/usr/local/bin/terraform | grep 'k8s-workers 1 -' | awk '{print $4;exit}')
ID_W1_DNS=$(/usr/local/bin/terraform output | grep 'k8s-workers 1 -' | awk '{print $9;exit}' | cut -b 8-)

ID_W2=$(/usr/local/bin/terraform output | grep 'k8s-workers 2 -' | awk '{print $4;exit}')
ID_W2_DNS=$(/usr/local/bin/terraform output | grep 'k8s-workers 2 -' | awk '{print $9;exit}' | cut -b 8-)

ID_W3=$(/usr/local/bin/terraform output | grep 'k8s-workers 3 -' | awk '{print $4;exit}')
ID_W3_DNS=$(/usr/local/bin/terraform output | grep 'k8s-workers 3 -' | awk '{print $9;exit}' | cut -b 8-)
